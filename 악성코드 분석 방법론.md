![image](https://github.com/ICTIS-Cert-System-Project/ICTIS-Cert-System/assets/18510716/4bcf1f12-aaf7-4015-a9db-e70a44b398d9)# 악성코드 분석 방법론
##### 작성자 : 김평일 대리, 김태현 사원
##### 작성일자 : 2024년 5월 23일
</br></br>
...
first-bytes-hex의 4D 5A는 MZ 파일의 시그니처 문자열을 뜻하며, 이는 .exe 파일에 사용되는 형식임.
